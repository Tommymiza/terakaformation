export const fr = {
    ...
    question: ["Comment s'appelle ton chien?", "Où est ta ville natale?", "Tu veux vivre où?", "Quel est ton film preféré?"],
    cours: [
        {
            ...
            liste: [
                {
                    titre: "Apprendre ici: Comment utiliser le centre de formation TERAKA",
                },
                {
