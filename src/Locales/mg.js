export const mg = {
    ...
    question: ["Iza ny anaran'ny alikanao?", "Taiza ny tanana nahaterahanao?", "Aiza ianao no te hipetraka?", "Inona ny film tinao indrindra?"],
    cours: [
        {
            ...
            liste: [
                {
                    titre: "Mianara eto: Ahoana ny fampiasana ny tranonkala fanofanana TERAKA",
                },
                {
