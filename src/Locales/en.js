export const en = {
  ...
  c201: [
    ...
    "WHY ARE TERAK VALUES IMPORTANT ?",
    "We create trust",
    ...
    "TERAKA is done by farmers, for farmers. By following the TIST Values, we work for each other and ourselves. These Values support community and accountability.",
  ...
  c207: [
    ...
    "Step 5: GO and DO",
    "At this point, farmers know enough and should   be encouraged to GO and DO! Continue training the TIST Farmers using the materials on the Learning Center and sharing  Best Practices in Small Groups and Clusters. Review the Learning Center trainings for how to  register the Small Group once they understand the Program",
