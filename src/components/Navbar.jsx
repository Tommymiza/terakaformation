    ...
    <Box>
      <AppBar position='static' sx={{background: "#ccc", p: 2}} className="d-flex flex-row justify-content-between align-items-center">
        ...
        <ul className='navbar d-flex flex-row col-md-4 col-sm-6 justify-content-around align-items-center gap-3 m-0'>
          <li title="Page d'accueil"><a href="https://teraka.vercel.app">Accueil</a></li>
          <li title="Le programme TERAKA"><a href="https://terakaprogram.vercel.app">Programme</a></li>
          <li title="Page des formations"><a href="https://terakajoin.vercel.app">Rejoindre</a></li>
        </ul>
      </AppBar>
    </Box>
  );
