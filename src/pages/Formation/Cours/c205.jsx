    ...
    <>
      {nb === 0 && (
        <div className="content">
          ...
          <p>
            ...
            takelaka ity dia hanazava anao ny fomba fidiran’ny Vondroa Madinika
            vaovao ho mpikambana ao amin’ny TERAKA. Araho tsara ny dingana
            rehetra mba ahafahanao sy ilay Vondrona misy anao mahatratra ny
            tanjona lehibe kanefa tsy dia mila fandaniana betsaka. Tadidio ary
            fa ny Vondrona Madinika mafy orina dia antoka manamafy ny TERAKA
            ihany koa.
          </p>
          <h4>
          ...
          <h4>Faharetany</h4>
          <p>
            Maharitra 12 ka hatramin’ny 18 volana eo ny fem-potoana ahafahan’ny
            Vondrona Madinika mameno ireo dingana ireo. Mandritr’izay fotoana,
            misy ny kilasiteran’ny TERAKA, ny mpiahy, na mpandraharaha tsotra
            izay manohana ny Vondrona Madinika, manome fiofanana azy ireo ary
            manao izay fomba ahazahoan’izy ireo ny fandaharan’asan’ny TERAKA.
          </p>
      ...
      {nb === 1 && (
        <div className="content">
          ...
          <p>
            ...
            mivondrona an-tsitrapo sy ankahalalahana mba hiara hamboly hazo, ho
            fanatsarana ny tany sy ny vondrom-piarahamonina. Tokony misy
            fianakaviana 3 samihafa ny ao anatn’ny Vondrona Madinika.
          </p>
          <h3>Inona ny atao hoe Kilasitera? </h3>
          <p>
            Araky ny efa nazavaina teo aloha, ny kilasiteran’ny TERAKA dia miisa
            30 katramin’ny 50 Vondrona Madinika izay tsy dia mifanalavitra
            fonenana, manana tany ahafahana mamboly hazo 200.000 (manodidina ny
            80 hekitara eo) ary manana pepiniera mba ahazahoana zanakazo.
          </p>
          <div className="action-center">
      ...
      {nb === 2 && (
        <div className="content">
          ...
          <p>
            Ny dingana voalohan’ny fidirana ho mpikambana ao amin’ny TERAKA dia
            na amin’ny alalan’ny fanatrehana mivantana ny Fampidirana sy ny
            Fampahafatarana momban’ny fiofanana ataon’ny TERAKA na manao izany
            amin’ny alalan’ny Ivon-toeram-piofanana.
          </p>
          <p>
            Ny Vondrona Madinika misy anao izany dia afaka miditra ho mpikambana
            ao amin’ny TERAKA amin’ny alalan’ny famenoana antota-taratasy
            fidirana na amin’ny alalan’ny fomba fidirana ao amin’ilay fomba
            fidirana ao anatin’ny ivon-toeram-piofanana. Ireo dingana rehetra
            ireo dia hazavaina ato amin’ity document manaraka ity:
          </p>
          ...
          <div className="content-part">
            ...
            <p>
              Ireo tantsaha izay liana amin'ny fidirana ho mpikambana ao amin’ny
              TERAKA dia tokony hitsidika ny tranonkalan’izy ireo:{" "}
              <a href="https://rejoindre.teraka.org">rejoindre.teraka.org</a>{" "}
          ...
          <div className="content-part">
            ...
            <p>
              ...
              dia tokony hifandray amin'ny TERAKA amin'ny alalan’ny WhatsApp ny
              tantsaha ary hijery ny Ivon-toeram-pianarana, ao amin’ny takelaka:
              Fampidirana sy fampahafantarana momban’ny fiofanana ataon’ny
              TERAKA hoan’ireo tantsaha liana amin’izany.
            </p>
          </div>
          <div className="content-part">
            <h5>
            ...
            <p>
              Avereno jerena tsara ny fampiofanana momba ny rafitry ny Vondrona
              Madinika ao anatin’ny Fampidirana amin’ny andian’ny faha4 amin’ny
              TERAKA 4 ao amin'ny ivon-toeram-pianarana. Ireo tantsaha, noho
              izany, dia tokony hamorona Vondrona Madinika misy olona 6
              katramin’ny 12 avy amin'ny fianakaviana 3 samihafa
            </p>
          </div>
          <div className="content-part">
            <h5>Dingana 4: Fidirana ho mpikambana ao amin’ny TERA</h5>
            <p>
              Vantany vao nahavita ny fiofanana ny Vondrona Madinika dia hisy ny
              Kilasitera mpanampy na Mpiahin’ny TERAKA hamita ihany koa: <br />
          ...
          <div className="content-part">
            ...
            <p>
              ...
              handrakitra an-tsoratra ny antsipirian'ny fivoriana, ary, raha azo
              atao dia manatrika ny fivorian’ny Kilasitera isam-bolana.
          ...
          <div className="content-part">
            ...
            <p>
              ...
              hampiasa ny ivon-toeram-piofanana na voarakitra ao amin'ny pejy 4
              amin'ny fangatahana hiditra ho mpikambana ao amin’ny TERAKA
            </p>
            <p>
              Ho an'ny tannin-kazo tsirairay dia mila an’ireto manaraka ireto ny
              ...
              f) Efa Ala ve io? Raha eny, oviana ny hazo no voatapaka? Raha hazo
              voatapaka latsaky ny 10 taona, dia tsy tafiditra anaty fepetra
              takian’ny TERAKA ilay tannin-kazo.
            </p>
          </div>
          <div className="content-part">
            <h5>
              Dingana 7: Raha voafenonao ny atonta-taratasy rehetra amin’ny
              fidirana ho mpikambana, dia atero any amin’ny Kilasitera Mpanampy
              izany.
            </h5>
            <p>
              Raha misy Vondrona Mandinika resy lahatra fa nahafeno soamantsara
              ny fangatahana hihiditra ho mpikambana ao amin’ny TERAKA dia ,
              afaka mangataka kilasitera mpanampy iray izy ireo mba ho
              hampiditra azy ho mpikambana anaty Vondrona Madinika an’ny TERAKA.
            </p>
            <p>
              Ny Kilasitera mpanampy dia hamerina hijery ny fangatahana amin’ny
              atsakany sy andavany, hamita ny bazelininan’ny tannin-kazon’ny
              isam-bondrona Madinika, hangataka ny Vondrona Madinika hanao Sonia
              ny fifanarahana EMH, ary hisoratra anarana ny Vondrona Madinika
            </p>
          </div>
          <div className="content-part">
            <h5>
            ...
            <p>
              ...
              ny mombamomban’ireo Vondrona Madinika amin'ny alàlan'ny fampiasana
              ny Fanavaozana ao amin'ny ivon-toeram-pianarana
            </p>
          </div>
          <div className="action-center">
            <button className="nav-btn" onClick={() => setNb(nb - 1)}>
      ...
      {nb === 3 && (
        <div className="content">
          <p>
            ...
            afaka miara-misehatra tsara amin'ny fambolena hazo hiadiana amin'ny
            fiovan'ny toetr'andro ary hanatsarana ny fiarahamonintsika. Ny
            dingana arahina moa dia miantomboka amin’ny fitsidihana ny
            tranonkalan’ny teraka.org, avy eo ny famolavolana ny Vondrona
            Madinika sy ny fivorian’ny Kilasitera, ary ny miresaka amin'ny
            mpikambana iray ao amin'ny TERAKA. Rehefa avy nanao ireo hetsika mba
            hamolavolana ireo faritra izay kasainao hambolena hazo ianao, dia
            hitsidika ny toeram-pambolenao ny Mpandrefy mba hahitany ny
            zava-bitanao. Ao anatin’izay, dia hihaona isan-kerinandro miaraka
            amin'ireo mpifanila trano aminao ianao, izay tianao hamoronana
            Vondrona Madinika TERAKA ary handraikitra hatrany an'ireo fivoriana
            ireo.
          </p>
          <p>
            ...
            anao ireo satria manainga anao hizara ny traikefanao sy hampivelatra
            ny fampiharana tsara indridnra, ary ihany koa mampiroborobo ny
            vondrona misy anao sy ilay fandaharan’asa. Mandray anao ampifaliana
            izahay ary manantena fa hiaraka hivelatra aminay ihany koa ianao ao
            anatin’izany.
          </p>
          ...
          <p>
            Ireo fiofanana takiana amin'ny fisoratana anarana: Ny fanatrehana ny
            fiofanana sy ny fivorian’ny Kilasitera dia anisan’ny zava-dehibe
            amin'ny fandaharan’asan’ny TERAKA. Ny kandidà rehetra dia tokony
            hanatrika ny fivorian’ny Kilasitera ho fanofanana momba ireo
            lohahevi-dehibe valo voatanisa etsy ambany. Ny fanohizana ny
          ...
          <p>
            Fivoriana isan-kerinandro ataon’ireo Vondrona Madinika: Ny fivoriana
            ataon’ireo Vondrona Madinika dia tena zava-dehibe amin'ny programa
            TERAKA. Manasa anao hampiasa ny espace eto ambany na ny
            tranokalan'ny TERAKA amin’ny Mobile mba handraiketana ny fivoriana
            isan-kerinandro. Rehefa feno ny tabilao etsy ambany dia ahazo pejy
            fanampiny ianao.
          </p>
          <div className="image-center-column">
            <img
          ...
          <p>
            ...
            takiana amin’ny fidirana ho mpikambana. Rehefa avy nanatrika an’ireo
            fivoriana tsy maintsy atrehana ianareo mpikambana ao anatin’ny
            Vondrona Madinika, sy naheno ireo zavatra tokony ho fantarina
            amin’ny tanin-kazo voatsonganareo, dia hanao toy izao manaraka izao
            ny mpikambana voafantina:
          </p>
          <ul style={{ marginLeft: "20px" }}>
            <li>
      ...
      {nb === 4 && (
        <div className="content">
          ...
          <ul style={{ marginLeft: "20px" }}>
            ...
            <li>
              Moa ve ny mpikambana ao amin'ny Vondrona Madinika dia avy amin'ny
              tokantrano 3 farafahakeliny?
            </li>
            <li>
              Nisy mpikambana (2 farafahakeliny) tao amin’ilay Vondrona Madinika
              ve nahazo fiofanana momban’ireo lohahevitra 8 tsy maintsy atao?
            </li>
            <li>
              Moa ve ny mpikambana rehetra ao amin'ny Vondrona Madinika dia
              nanatrika ny antsasaky ny fivorian’ny Vondrona Madinika natao tao
              anatin'ny 12 herinandro lasa farafahakeliny?
            </li>
            <li>
              Nampihatra an’ilay fifandimbiasan’ny fitarihina isaky ny fivoriana
              isan-kerinandro ve ny Vondrona Madinika?
            </li>
            <li>
            ...
            <li>
              Manana porofo momba ny zon'ny tany isaky ny aloka tiany hosoratana
              ve ny SG?
            </li>
            <li>
            ...
            <li>
              Fantatry ny mpikambana rehetra ao amin'ny Vondrona Madinika ve ny
              soatoavin'ny TERAKA ary manaiky ny hanaraka izany ve izy ireo?
            </li>
            <li>
              Fantatry ny mpikambana rehetra ao amin'ny Vondrona Madinika ve ny
              fepetra takian'ny TERAKA?
            </li>
            <li>
          ...
          <ul style={{ marginLeft: "20px" }}>
            ...
            <li>
              Hanome fiofanana an’ireo Vondrona Madinika momban’ny fifanarahana
              EMH ny Kilasitera Mpanampy
              <ul style={{ marginLeft: "20px" }}>
                <li>
            ...
            <li>
              Miseo ao anaty tahirin-kevitry ny mpangataka hiditra ho mpikambana
      ...
      {nb === 5 && (
        <div className="content">
          ...
          <p>
            Jereo ary raha toa ka mahafeno ny mason-tsivana ahafahana miditra ho
            mpikambana ao amin’ny TERAKA ny Vondrona Madinika misy anao.
          </p>
          <p>
            Fanampiana anao ahazo ireo zavatra rehetra takiana mba ahafahana
            miditra ho Vondrona Madinika ao amin’ny TERAKA ity fanontaniana ity.
            Ny agent kilasitera, ny Mpiahy, na ny mpandraharaha tsotra dia
            milaza aminao raha toa ka mahafeno ny fepetra rehetra takiana ny
            VOndorna Madinikao na tsia.
          </p>
          <h3>Fanadinana:</h3>
          <Test205 />
          <div className="action-center">
      ...
      {nb === 6 && (
        <div className="content">
          ...
          <p>
            Ny kilasiteran’ny TERAKA, ny mpiahy, na ny mpandraharaha tsotra dia
            mifandray amin’ny Vondrona Madinika misy anao mba hanangonana
          ...
          <p>
            Ny bazelinina dia ny toetran’ny taninjanakazon’ny Vondrona Madinika
            tamin’ny fahatongavan’ny Vondrona Madinika voaloha tao amin’ny
            TERAKA.
          </p>
          <p>
            ...
            porofo fananan-tany na fahazahoan-dalana hamboly eo amin’ilay tany.
          </p>
          <h3>Inona ny karazana information ilaina amin’ny bazelinina?</h3>
          <p>
          ...
          <ul style={{ marginLeft: "20px" }}>
            ...
            <li>
              Tanin-kazo bazelinina: ny foto-kazo rehetra ao anaty ala, ny fomba
              nampiasana ny tannin-kazo alohan'ny fambolena hazon’ny TERAKA, ary
              ny zava-misy hafa momba ny tannin-kazo
            </li>
            <li>
              Sarin’ny: a) Vondrona Madinika, b) ny tanin-kazo tsirairay, d) Ny
              tany nampiharana ny fambolena maharitra; e) ny fatana voatsara ary
              f) ny pepiniera
            </li>
          </ul>
          ...
          <p>
            ...
            fivorian’ny kilasitera isam-bolana ny Vondrona Madinikan’ny TERAKA.
            Misy agent kilasitera mandrindra an’ireo fivoriana ireo ary kendrena
            mba atao any amin’ny toerana mora hit any fihaonana. Mandritran’ny
            fivoriana, ny Tantsahan’ny TERAKA dia:
          </p>
          <ul style={{ marginLeft: "20px" }}>
            <li>
              Mahazo taratasim-pilazam-baobao isam-bolana, ary ataony tonga any
              amin’ny Vondrona Madinika misy azy io
            </li>
          ...
          <p>Mety haka angovom-baovao hafa ihany koa ireo solon-tena toy ny:</p>
          <ul style={{ marginLeft: "20px" }}>
            <li>Fanamarinana ny hazo mihoatra ny 6 volana</li>
            <li>Fanamarinana ny fambolena maharitra</li>
            <li>Ny momban’ny pepiniera</li>
            <li>
              Faritra amoron-drano (raha to aka manamorina ny loharano na farihy
              ny tanin-kazo)
            </li>
          </ul>
          <div className="action-center">
      ...
      {nb === 7 && (
        <div className="content">
          ...
          <p>
            Raha mampiseo ny fananan’ny vondrona misy anao an’ireto ny bselinina
            ny tanin-kazo:
          </p>
          <ul style={{ marginLeft: "20px" }}>
            <li>Farafahakeliny tany 2 hektara hambolena ny hazon’ny TERAKA</li>
      ...
      {nb === 8 && (
        <div className="content">
          ...
          <p>
            Raha mahafeno ireo fepetra rehetra takiana ny Vondrona Madinika, dia
            iaraka hijery ny Fifanarahana amin’ny EMH ny Vondrona Madinika sy ny
            kilasitera, ny mpiahy na ny mpandraharaha tsotran’ny TERAKA.
          </p>
          <ul style={{ marginLeft: "20px" }}>
            <li>
