    ...
    <>
      {nb === 0 && (
        <div className="content">
          ...
          <p>
            ...
            Madinika amin'ny Programa TERAKA ianao. Ireo Vondrona Madinika an’I
            TERAKA dia anisan’ny manan-danja indrindra amin'ity fandaharan’asa
            ity. Tokony hieritreritra tsara ianao alohan'ny hanangananao an’ity
            Vondrona Madinika ity satria hiara-hiasa amin'ireo mpikambana hafa
            ireo ianao mandritra ny 60 taona (faharetan’ny fifanarahana EMH
            izany)! Ny mpikambana ao amin'ny Vondrona Madinik’I TERAKA dia
            mifampizara vaovao amin'ny tsirairay sy ny Vondrona Madinika hafa,
            mifampitana andraikitra ary mamolavola ireo fampiharana tsara an’i
            TERAKA vaovao.
          </p>
          ...
          <p>
            ...
            fianakaviam-ben’ny TERAKA. Mila fieritreretana tsara ny fananganana
            Vondrona Mandinika. Ny Vondrona Madinika dia ahitana namana sy
            mpifanolo-bodirindrina, ary ahafahan'ny mpikambana TERAKA hamptombo
            ny trai-kefa amin'ny maha-mpitarika azy izany. Ny Vondrona Madinika
            TERAKA manara-penitra dia misy olona miasa mafy ary mametraka ny
            Soatoavin’ny TERAKA. Matetika ny lehilahy sy ny vehivavy ao amin'ny
            Vondrona Madinika iray no mahavita be indrindra.
          </p>
          ...
          <ul style={{ marginLeft: "20px" }}>
            <li>
              Manolo-tena hamboly hazo 1000 farafahakeliny isan-taona mandritra
              ny 5 taona{" "}
            </li>
      ...
      {nb === 1 && (
        <div className="content">
          ...
          <ul style={{ marginLeft: "20px" }}>
            <li>
              Ny lehilahy sy ny vehivavy ao amin'ny Vondrona Madinika iray ihany
              matetika no mahavita be indrindra.
            </li>
            <li>
              Ny Vondrona madinika dia manampy ny mpikambana ao aminy
              hifampitondra andraikitra. Rehefa tafita ny olona iray dia tafita
              avokoa ny vondrona iray manontolo. Raha misy manao ratsy dia
              voaratra avokoa ny vondrona
            </li>
            <li>
              Ny Vondrona Madinika dia manampy ny mpikambana hifampi-tantsoroka
              sy hifampizara sy traikefa
            </li>
            <li>
            ...
            <li>
              Hiaraka hananatatra vokatra lehibe avy amin’ny teti-bola tsy lafo
              ny Vondrona Madinika miaramiasa
            </li>
            <li>
        ...
        <div className="content">
          ...
          <ul style={{ marginLeft: "20px" }}>
            ...
            <li>
              ...
              amin’ny fikajiana fotoana. Ny Mpitarika mpanampy no lasa Mpitarika
          ...
          <p>
            Ny fifandimbiasan’ny fitarihina dia anisan’ny fampiharana tsaran’ny
            TERAKA ho an'ny vondrona madinika. Mifandimby isaky ny fivoriana
            (isan-kerinandro) ny fitarihana, ka ny Mpitarika mpanampy no lasa
            Mpitarika, ny Tompon'andraikitra lasa Mpitarika mpanampy, ary ny
            olona tompon'andraikitra vaovao no hofidiana.
          </p>
          <p>
          ...
          <ul style={{ marginLeft: "20px" }}>
            ...
            <li>
              Samy manana ny fanomezam-pahasoavana atolotra ny olona tsirairay.
              Tsy fantatsika foana hoe inona izy ireo raha tsy nomena fahafahana
              isika
            </li>
            <li>Misy fahafahana mitovy ho an'ny lehilahy sy ny vehivavy.</li>
            <li>
              Ny fifandimbiasan’ny fitarihina dia mamporisika ny olona vaovao sy
              ireo izay saro-kenatra hahay hitarika
            </li>
            <li>
              Afaka manolo-tena amin'ny maha-mpitarika ny olona na dia mbola tsy
              manolo-tena amin'ny fitarihana mandritra ny taona maro aza.
            </li>
            <li>
              Mifampianatra momba ny maha-mpitarika tsara avy amin’ny tsirairay
              isika.
            </li>
            <li>
              Ny fifandimbiasan’ny fitarihina dia manome antoka fa misy hevitra
              vaovao sy karazana fitarihana vaovao ampiasaina isaky ny Vondrona
              Madinika.
            </li>
          </ul>
          <div className="action-center">
      ...
      {nb === 3 && (
        <div className="content">
          ...
          <ul style={{ marginLeft: "20px" }}>
            ...
            <li>
              Mampita ny fifandraisana rehetra avy amin’ny Kilasiteran’ny TERAKA
              eo an-toerana
            </li>
            <li>
            ...
            <li>Mitantana ny fifidianana izay ho tompon’andraikitra vaovao</li>
          </ul>
          <p>
          ...
          <ul style={{ marginLeft: "20px" }}>
            <li>Mitarika ny fivoriana raha to aka tsy tonga ilay mpitarika</li>
            <li>Mikajy hatrany ny fotoana mandritra ny fivoriana</li>
            <li>
              Mandray antsoratra ireo fivoriana sy ny fifanakalozan-kevitra atao
              ao
            </li>
          ...
          <p>
            Ny olona tompon’nandraikitra ao amin’ny Vondrona Madinika TERAKA dia
            manana ireto andraikitra ireto:
          </p>
          <ul style={{ marginLeft: "20px" }}>
            <li>
      ...
      {nb === 4 && (
        <div className="content">
          ...
          <p>
            ...
            tokony ho voafaritra tsara ary manondro zavatra nataon’ny Mpitarika
            na nolazaina. Dinio tsara izany zavatra izany. Tsy tokony ho
            fanehoan-kevitra ankapobe toy ny hoe "nanao asa tsara ny Mpitarika".
            Tokony ho fanehoan-kevitra manokana toy ny hoe "ny Mpitarika dia
            nitana fotoana, nitsiky, ary namporisika ny mpikambana ao amin’ny
            Vondrona Madinika rehetra hiteny.
          </p>
          <p>
          ...
          <p>
            ...
            setrin'ny Kujengana dia miteny fotsiny ny Mpitarika hoe "Misaotra."
            Tsy misy resaka momba ny fomba azo nantao mba hahatsara an’ilay
            zavatra natao anefa.
          </p>
          <p>
          ...
          <p>
            ...
            zavatra manan-danja ho fandraisana anajara amin’izany. Kujengana dia
            fampiharana ny filazana ny lanjan-javatra iray ho ren’ny olona
            rehetra. Toy ny fifandimbiasan’ny fitarihana, ny Kujengana dia
            zava-dehibe amin’ny fampiroboroboana ny haitarika ao amin’ny TERAKA.
          </p>
          <div className="action-center">
            <button className="nav-btn" onClick={() => setNb(nb - 1)}>
              Hiverina
      ...
      {nb === 5 && (
        <div className="content">
          ...
          <ul style={{ marginLeft: "20px" }}>
            ...
            <li>
              Ny Kujengana dia zava-dehibe amin’ny fampiroboroboana ny mpitarika
              ao amin’ny TERAKA
            </li>
            <li>
      ...
      {nb === 6 && (
        <div className="content">
          ...
          <p>
            ...
            Vondrona Madinika. Ny kilasitera iray dia misy Vondrona Madinika 30
            hatramin’ny 50 izay tsy dia mifanalavitra toeram-ponenana.
          </p>
      ...
      {nb === 7 && (
        <div className="content">
          ...
          <p>
            ...
            fitarihana mihodinkodina. Na izany aza, ny Clusters dia manodina ny
            Leadership isaky ny 4 volana. Midika izany fa ny mpikambana
            tsirairay ao amin'ny Cluster dia hanana 12 volana amin'ny fanompoana
            (4 volana ho tompon'andraikitra, 4 volana ho mpiara-mitarika, ary 4
            volana ho mpitarika ny Cluster).
          </p>

          <p>
            Tahaka ny ao amin'ny Vondrona Madinidinika TERAKA, ny vehivavy sy ny
            lehilahy dia mifandimby. Ary indray, toy ny ao amin'ny Vondrona
          ...
          <p>
            ...
            tompon’andraikitra dia manana andraikitra mitovy amin'ny ao amin'ny
            Vondrona madinikan’i TERAKA. Manana andraikitra fanampiny koa izy
            ireo:
          </p>
          ...
          <ul style={{ marginLeft: "20px" }}>
            ...
            <li>
              ...
              misy tatitra isam-bolana sy tatitra mombany kaonty dia voatatitra
              ara-dalàna any any amin'ny Mpitarika an’ny TERAKA{" "}
            </li>
            <li>
              Manampy amin'ny fandraisana olona vaovao hiditra ho mpikambana ao
              amin’ny TERAKA
            </li>
            <li>
              Manampy ny Vondrona Madinika mba hahazo, hanasonia ary hampiditra
              ny fifanarahana momba ny Entona Mangeja Hafanana.
            </li>
            <li>
          ...
          <ul style={{ marginLeft: "20px" }}>
            ...
            <li>
              Mandritra ny fandoavam-bola dia manome tapakila ho an'ny Vondrona
              Madinikan’ny TERAKA misy mpikambana roa manatrika. manamarina ny
              tapakila, mifandray amin'ny mpiandraikitra ny fandoavam-bola, ary
              manaraka ny fizotran'ny fandoavam-bola amin'ny fomba mazava sy
              mahitsy.
            </li>
          </ul>
          <div className="action-center">
      ...
      {nb === 8 && (
        <div className="content">
          ...
          <p>
            Misy tombotsoa maro be azo avy amin’ny rafitry ny Vondrona Madinika
            sy ny Kilasitera:
          </p>
          <ul style={{ marginLeft: "20px" }}>
            <li>
            ...
            <li>
              Ny Kilasitera dia manampy ny Vondrona madinika hifampiresaka mora
              foana
            </li>
            <li>
      ...
      {nb === 9 && (
        <div className="content">
          ...
          <p>
            Raha toa ka manaraka ny fiofanana anatin’ny Vondrona Madinika ianao,
            dia aza adino ny mampihatra ny Fampiharana tsaran’ny Vondrona
            Madinika: manana mpitarika, mpitarika mpanampy, ary olona
