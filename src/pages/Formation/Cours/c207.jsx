    ...
    <>
      {nb === 0 && (
        <div className="content">
          ...
          <p>
            ...
            traikefany miaraka amin’ny TERAKA. Maro be ny dingana arahina mba ho
            lasa mpikambana ao: manomboka amin’ny fahalalana momban’ny TERAKA
            aloha aveo rehefa tafiditra ao amin’ny VOndrona Madinika ka afaka
            mandray anjara amin’ny vola karbaona. Ity fiofanana ity dia
          ...
          <h3>Fampitomboana ny TERAKA: Ahoana no fomba fihitatry ny TERAKA?</h3>
          ...
          <div className="content-part">
            ...
            <p>
              Avereno jerena ny fomba fidirana ao amin’ny TERAKA andian’ny faha
              5 “ Ahoana no fomba hidirana ho Vondorona Madinika TERAKA ” mba
              hahafahana manampy ny tantsaha hanangana Vondrona Madinika
          ...
          <div className="content-part">
            ...
            <p>
              ...
              dia-tongotra. Raha misy Vondrona Madinika latsaky ny 30 ao amin'ny
              faritra misy anao dia mbola afaka manomboka Kilasitera ianao.
              Tohizo hatrany ny fampidirana Vondrona Madinika
          ...
          <div className="content-part">
            ...
            <p>
              ...
              amin’ny fizarana ny fomba fiasa tsaran’ny Vondrona Madinika sy ny
              Kilasitera Avereno jerena ny fiofanana ao amin'ny
      ...
      {nb === 1 && (
        <div className="content">
          ...
          <div className="content-part">
            <p>
              Mifanentana amin'ny alàlan'ny fiaraha-miasa amin'ireo mpitarika eo
              an-toerana
            </p>
          </div>
          <div className="content-part">
          ...
          <div className="content-part">
            <p>
              ...
              fandoavam-bola amin’ny hazo, ny hazo fihinam-boa, na ny fambolena
              maharaitra
            </p>
          </div>
          <div className="content-part">
      ...
      {nb === 2 && (
        <div className="content">
          ...
          <p>
            ...
            fanontaniana manitikitika anai dia manasa anao izahay hiverina anao
            ny fiofananan. Na ihany koa, raha to aka ao anaty Vondrona Madinika
            ianao no manao ity fiofananan ity, dia tadidio hatrany ireo
            fampiharana tsara tokony ataon’ny Vodrona Madinika amin’ny fananana
            Mpitarika, Mpitarika Mpanampy, ary Olona tompon’andraikitra. Ary
            farany fa tsy kely indrindrindra, aza adino ny mampihatra ny
            fifanorenana.
          </p>
          <p>
