      ...
      <>
        {nb === 0 && (
          <div className="content">
            ...
            <p>
              Eo amin'ny manodidina antsika ny karbôna, nefa tsy afaka mahita
              azy, na mikasika azy, na manandrana azy isika - inona moa izany?
            </p>
            <p>
              Ity takelaka manaraka ity dia manazava ny atao hoe karbaona sy ny
              maha-zava-dehibe izany amin'ny zava-manan’aina rehetra eto
              an-tany. Ho fantatrao koa hoe maninona no manimba tontolo iainanan
              ny fandoroana angovo natoraly ary manome vahana ny fiovaovan'ny
            ...
            <p>
              Ny karbaona no fototry ny zavamananaina rehetra. Manodidina
              antsika izy io ary ampahany amintsika:
            </p>
            <ul style={{ marginLeft: "20px" }}>
              ...
              <li>
                Ny solika ampiasaintsika isan'andro dia vita amin'ny karbaona
                koa: solika toy ny lasantsy, petrola, ary kitay fandrahoana
                sakafo
              </li>
            </ul>
            <p>
              Rehefa mandoro solika mifototra amin'ny karbaona isika, dia
              mamorona setroka mandoto ny rivotra iainana izany ary mamadika ny
              tafo fanitso ho mainty.
            </p>
            <p>
            ...
            <p>
              ...
              anampian'ny Mpamboly TERAKA amin'ny fanatanterahana ny
              tsingerin'ny karbaona amin'ny alalan'ny fambolen-kazo.
            </p>
            <p>
              Ny karbaona dia hita eny rehetra eny amin'ny tany. Ny karbaona no
              mandrindra ny mari-pana ny tany, no fototry ny tondra-drano
              rehetra, ary loharanon-tsolika lehibe. Ny karbaona no fototry ny
              zava-manan’aina rehetra eto an-tany. Ny karbaona dia hita ao
              amin'ny atmosfera amin'ny endrika gazy karbonika na CO2. Tsy
              hitan’ny maso ny karbaona, na fatatra tsiro, na rem-pofona, fa
              manodidina antsika.
            </p>
            <p>
            ...
            <p>
              Ny hain-tany lavareny sy ny fiakaran’ny hafanana dia samy vokatry
              ny fiovaovan'ny toetr'andro. Saingy misy zavatra tsotra azontsika
        ...
        {nb === 1 && (
          <div className="content">
            ...
            <div className="content-part">
              ...
              <p>
                Ny orinasam-bola karbônina dia ny fomba handraisan'ny iTERAKA
                vola amin'ny fampandehanana ny programa TERAKA
              </p>
            </div>
            ...
            <p>
              Ny Vondrona Madiniky ny TERAKA dia manao sonia fifanarahana
              amin'ny iTERAKA, ilay orinasa mitantana ny Programa TERAKA
            </p>
            <div className="image-center-column">
              <img
            ...
            <p>
              Ny iTERAKA dia manakarama mpanamarina mba hahazoana antoka fa
              marina io fandrefesana io
            </p>
            <div className="image-center-column">
              <img
            ...
            <p>
              Ny iTERAKA dia mizara ny tombom-barotra amin'ny fivarotana ny
              kredi karbaona amin'ny tantsahan’ny TERAKA
            </p>
            <p>Izany dia antsoina hoe Fizarana tombony</p>
            <p>
              Dia izay sy izay no tombontsoa azon’ny Vondrona Madinika ao
              amin’ny TERAKA amin’ny alalan’ny fandraharahana ao amin’ny
              karbaona
            </p>
            <div className="image-center-column">
              <img
          ...
          <div className="content">
            ...
            <div className="content-part">
              ...
              <p>
                ...
                hamoronana crédit karbonika. Mandra-pahalehiben'ny hazo TERAKA
                dia hahazo fandoavana 0,02 dolara isaky ny hazo isan-taona ny
                Vondrona Madinika TERAKA mba hitazonana ilay hazo hitombo.
              </p>
            </div>
            <div className="content-part">
              <h5>FIzarana ny tombon’ny karbaona</h5>
              <p>
                Rehefa lehibe ny hazo ary mahafeno ny fepetra rehetra azo atao
                ny Vondrona Madinika, dia hahazo anjara tombony ny Vondrona
                Madinika an’i TERAKA. Ny fizaran’ny tombony dia noforonina
                rehefa mivarotra ny kredi karbaona amin'ny olona na orinasa hafa
                ny iTERAKA, ary ny iTERAKA dia mizara ny iTERAKA 70% amin’ny
                tombom-barotra azony amin’ny tantsahan’ny TERAKA.
              </p>
            </div>
            <div className="content-part">
              ...
              <p>
                ...
                Ity kredi karbaona ity dia amidy amin'ny olona na orinasa hafa
                te hanampy ny tontolo iainana.
              </p>
            </div>
            <div className="action-center">
              <button className="nav-btn" onClick={() => setNb(nb - 1)}>
        ...
        {nb === 3 && (
          <div className="content">
            ...
            <p>
              Ankoatra ny vola karbaona dia manana tombon-tsoa maro hafa ihany
              koa ireo tantsahan’ny TERAKA
            </p>
            <div className="image-center-column">
              <img
                src="/images/203_2.png"
            ...
            <div className="content-part">
              ...
              <div className="row-content">
                <ul>
                  ...
                  <li>
                    Ireo karazana fatana ireo dia tsy mila mampiasa kitay maro
                    be ary tena mandaitra.
                  </li>
                  <li>
              ...
              <div className="row-content">
                <ul>
                  ...
                  <li>
                    ...
                    mandavaka tany ary aveo fenoina kaompaosita misy
                    zezi-pahitra ilay lavaka mialohan’ny hambolena hazo
                  </li>
                </ul>
            ...
            <div className="content-part">
              ...
              <p>
                Mahazo fiofanana momban’ny fanaovana zezika kompaosita tokoa
                ireo mpambolin’ny TERAKA. Manampy ireo tantsaha amin’ny
                fahazahoana vokatra miavosa izany, ary manampy ny tontolo
                iainana, ary amin’izay ihany koa mba tsy mila mividy zezika.
              </p>
            </div>
            <div className="image-center-column">
              <img
            ...
            <div className="content-part">
              ...
              <p>
                Ireo tantsahan’ny teraka rehetra dia manana anjara ho mpitarika
                sy hisitraka fiofanana ho mpitarika avokoa.
              </p>
              <p>
        ...
        {nb === 4 && (
          <div className="content">
            ...
            <p>
              Amin'ny fiofanana manaraka dia hianatra bebe kokoa momba ny
              rafitry ny TERAKA sy ny maha-zava-dehibe ny Vondrona Madinik’i
              TERAKA ianao.
            </p>
            <div className="action-center">
              <Rating
